...
insert into `Bookings` values (1, '2022-1-11', '2022-1-12', 4, 3, null, 2);
insert into `Bookings` values (2, '2021-07-11', '2021-07-12', 1, 1, 1, 3);
insert into `Bookings` values (3, '2021-07-11', '2021-07-14', 1, 2, 2, 1);
insert into `Bookings` values (4, '2021-07-09', '2021-07-12', 1, 4, 3, NULL);
insert into `Bookings` values (5, '2021-07-21', '2021-07-23', 1, 4, NULL, NULL);
